...
def main():
    ...
    if TRAIN:
        ...
        np.save('train_log_ERM_{}_{}_{}.npy'.format(ENV_NUM, STEP_N, lucky_no), train_log)

        temp_log = np.array(temp_log)
        np.save('temp_log_ERM_{}_{}_{}.npy'.format(ENV_NUM, STEP_N, lucky_no), temp_log)
